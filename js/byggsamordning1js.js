  ...
  show: function(no) {
    var layersBygg = {
      ...
      "1":  ["ds_fgk_pg_fgk_projekt_antura_p", "#ffae3d", [
        ['Projekt ID', 'projid'],
        ['Projektnamn', 'projektnamn_eko'],
        ['Startdatum', 'startdatum_antura'],
        ['Slutdatum', 'slutdatum_antura'],
        ['Fas', 'fas_antura'],
        ['Projekttyp', 'projekttyp_antura'],
      ...
      "5": ["ds_fgk_pg_mu_ytor_bygg", "#9999FF", [
        ['Tillstandsnr', 'avtal_tillstandsnr'],
        ['Namn', 'namn'],
        ['Startdatum', 'startdatum'],
        ['Slutdatum', 'slutdatum'],
    ...
    if (no == 1) {
      ...
      jq('#testSida2').load("/modules/byggsamordning/html/byggsamordning.html", function() {
        ...
        // --------------------------------------Slider tool--------------------------
        window.console.log('test_test123')
        ...
        if(e.feature.cluster){
          ...
          for(var i=0; i<e.feature.cluster.length; i++) {
            ...
            for(j=0;j<(layersBygg[val][2].length-1);j++){
                html += "<p><b>"+layersBygg[val][2][j][0]+": </b>"+e.feature.cluster[i].attributes[layersBygg[val][2][j][1]] + "</p>"
            }
            html+="</div>";
          }
          ...
          html+="<div class='innerpop'>";
          for(j=0;j<(layersBygg[val][2].length-1);j++){
            // html += "<p><b>"+layersBygg[val][2][j][0]+": </b>"+e.feature.attributes[layersBygg[val][2][j][1]].toLowerCase() + "</p>";
